...
function verif($otp, $token)
    {
    $data = '{"client_name":"gojek:cons:android","data":{"otp":"' . $otp . '","otp_token":"' . $token . '"},"client_secret":"4b3238a2-492c-4e51-9df7-340e6d94c3a1"}';
...
function reff($token)
	...
	function cekno($no)
    {
	$token = '4b3238a2-492c-4e51-9df7-340e6d94c3a1';
